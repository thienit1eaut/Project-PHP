tinymce.PluginManager.add("enuyfilemanager", function(e) {
    function n(t) {
        console.log(t);
        0 === e.settings.external_filemanager_path.toLowerCase().indexOf(t.origin.toLowerCase()) && "enuyfilemanager" === t.data.sender && (tinymce.activeEditor.insertContent(t.data.html), tinymce.activeEditor.windowManager.close(), window.removeEventListener ? window.removeEventListener("message", n, !1) : window.detachEvent("onmessage", n))
    }
    ...
    e.addButton("enuyfilemanager", {
        icon: "browse",
        tooltip: "Thêm tệp tin",
        shortcut: "Ctrl+E",
        onclick: t
    }), e.addShortcut("Ctrl+E", "", t), e.addMenuItem("enuyfilemanager", {
        icon: "browse",
        text: "Thêm tệp tin",
        shortcut: "Ctrl+E",
        onclick: t,
