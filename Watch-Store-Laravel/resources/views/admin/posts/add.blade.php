 ...
 <div class="container-fluid">
    ...
    <div id="Breadcrumb" class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom">
        ...
        <ul>
            ...
            <li class="SecondLast"><a href="{{url('')}}Techsystem/view/post">Tên bảng</a></li>


            <li class="Last"><span>Thêm mới bài viết</span></li>
    ...
    <div id="cph_Main_ContentPane">
       ...
       <div class="widget">
        ...
        <div class="widget-title">
         ...
         <h4><i class="icon-list-alt"></i>&nbsp; Thêm mới bài viết</h4>
...
<div id="hiddenToolBarScroll" class="scrollBox" style="display:none;">
  ...
  <h4>
   ...
   <i class="icon-list-alt"></i>&nbsp; TIN TỨC
...
<div class="widget-body">
    ...
    <form  name="addform" id="mainform"  action="Systemadmin/add-post" method="post">


        <input type="hidden" name="tech5s_controller" value="PostController">


        <input type="hidden" name="tech5s_type" value="insert">
        ...
        <div id="tabs" style="" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <ul class="nav nav-tabs ui-tabs-nav " role="tablist">
                ...
                <li class="" role="tab" aria-controls="tabs-edit-2">
                    ...
                    <span class="ui-tabs-anchor" onclick="return false;">Nội dung</span>
            ...
            <div id="tabs-edit-1" role="tabdiv" style="display: block">
                ...
                <div class="container-fluid padding0 tableedit">
                    ...
                    <div class="row margin0">
                        ...
                        <div class="col-md-10 col-xs-12">
                            ...
                            <div style="" class="switch">
                                ...
                                <input checked onclick="clickkickord(this)"  id="cmn-toggle-ord"  class="cmn-toggle cmn-toggle-round"  type="checkbox">


                                <label for="cmn-toggle-ord"></label>
                    ...
                    $(function() {
                        ...
                        $('input[name=ord]').val($('#cmn-toggle-ord').is(':checked')?"1":"0")


                    });


                    function clickkickord(_this){


                        $('input[name=ord]').val($(_this).is(':checked')?"1":"0");
                    ...
                    <div class="row margin0">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <input class="datepicker" value="{{isset($dataitem)? date(" d-m-Y H:i:s ",time()):date("d-m-Y H:i:s ",time())}}" type="text" placeholder="Thời gian tạo" onkeydown="">
                            <input type="hidden" value="{{isset($dataitem)? $dataitem[$field['name']]:time()}}" name="created_at">
                        </div>
                    </div>
                    ...
                    <div class="row margin0">
                        ...
                        <div class="col-md-10 col-xs-12">
                            <input class="datepicker" value="{{isset($dataitem)? date(" d-m-Y H:i:s ",time()):date("d-m-Y H:i:s ",time())}}" type="text" placeholder="Thời gian cập nhật" onkeydown="">
                            <input type="hidden" value="{{isset($dataitem)? $dataitem[$field['name']]:time()}}" name="updated_at">
                        </div>
                    </div>
                ...
                <div class="container-fluid padding0 tableedit">
                    ...
                    <div class="row margin0">
                        ...
                        <div class="col-md-10 col-xs-12">
                            ...
                            <textarea name="short-content" id="short-content" style="visibility:visible !important" rows="4"></textarea>
                ...
                <div class="container-fluid padding0 tableedit">
                    ...
                    <div class="row margin0">
                        ...
                        <div class="col-md-10 col-xs-12">
                            ...
                            <input value="" type="text" name="s-title">
